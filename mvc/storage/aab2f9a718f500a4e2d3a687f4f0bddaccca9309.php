                        ...
                        <aside class="widget-container">
                            <div class="widget-content">
                                <div class="footer-logo mb-half">
                                    <img src="<?php echo e(PUBLIC_URL . 'assets/images/footer-logo.png'); ?>" alt="Footer Logo">
                                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="footer-payment">
                        <a href="#"><img src="<?php echo e(PUBLIC_URL . 'assets/images/icons/payment.png'); ?>" alt="Payment Icons"></a>
                    </div>
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of footer-copyright -->
</footer><?php /**PATH E:\xampp\htdocs\pt15312-web-php2\mvc\app\views/layouts/client/footer.blade.php ENDPATH**/ ?>