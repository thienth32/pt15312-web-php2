            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide bg-img-wrapper">
                    <div class="slide-inner image-placeholder">
                        <img src="<?php echo e(PUBLIC_URL . 'assets/images/slider/home-1/slide-1.jpg'); ?>" class="visually-hidden" alt="Slider Image">                          
                ...
                <div class="swiper-slide bg-img-wrapper">
                    <div class="slide-inner image-placeholder">
                        <img src="<?php echo e(PUBLIC_URL . 'assets/images/slider/home-1/slide-2.jpg'); ?>" class="visually-hidden" alt="Slider Image">
                        <div class="slide-progress"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                ...
                <div class="swiper-slide bg-img-wrapper">
                    <div class="slide-inner image-placeholder">
                        <img src="<?php echo e(PUBLIC_URL . 'assets/images/slider/home-1/slide-3.jpg'); ?>" class="visually-hidden" alt="Slider Image">
                        <div class="slide-progress"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-6 col-sm-6 col-md-4 col-lg-4">
                    <div class="promo-banner hover-effect-1">
                        <a href="#">
                            <img src="<?php echo e(PUBLIC_URL . 'assets/images/banners/banner-1.jpg'); ?>" alt="Promo Banner">
                        </a>
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-4">
                    <div class="promo-banner hover-effect-1">
                        <a href="#">
                            <img src="<?php echo e(PUBLIC_URL . 'assets/images/banners/banner-2.jpg'); ?>" alt="Promo Banner">
                        </a>
                    </div> <!-- end of promo-banner -->
                </div>
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="promo-banner hover-effect-1">
                        <a href="#">
                            <img src="<?php echo e(PUBLIC_URL . 'assets/images/banners/banner-3.jpg'); ?>" alt="Promo Banner">
                        </a>
                    </div> <!-- end of promo-banner -->
                </div>
            </div> <!-- end of row -->
                                            ...
                                            <div class="product-caption">
                                                <div class="product-meta d-flex justify-content-between align-items-center">
                                                    <div class="product-manufacturer">
                                                        <a href="#"><?php echo e($item->category->cate_name); ?></a>
                                                    </div>
                                                ...
                                                <h4 class="product-name"><a href="single-product.html"><?php echo e($item->name); ?></a></h4>
                                                <p class="product-price">
                                                    <span class="price-new">$<?php echo e(number_format($item->price, 0, '.', '.')); ?></span>
                                                </p>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="banner-with-text">
                            <img src="<?php echo e(PUBLIC_URL . 'assets/images/backgrounds/bg-banner.jpg'); ?>" class="visually-hidden" alt="Promo Banner">
            ...
            <div class="row product-row">
                <div class="col-12 col-sm-12 col-md-12">
                    ...
                    <ul class="nav nav-pills justify-content-center" id="our_categories" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php if($loop->index == 0): ?> active <?php endif; ?>" id="nav_tablist-<?php echo e($tl->id); ?>" data-toggle="pill" href="#tablist-<?php echo e($tl->id); ?>" role="tab" aria-controls="tablist-<?php echo e($tl->id); ?>" aria-selected="true"><?php echo e($tl->cate_name); ?></a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul> <!-- end of nav -->
                    ...
                    <div class="tab-content" id="our_categories_contents">
                        <?php $__currentLoopData = $tablistCate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tab-pane show <?php if($loop->index == 0): ?> active <?php endif; ?> anime-tab" id="tablist-<?php echo e($tl->id); ?>" role="tabpanel" aria-labelledby="nav_tablist-<?php echo e($tl->id); ?>">
                            <div class="new-products pos-r">
                                <div class="element-carousel" data-visible-slide="4" data-loop="false" data-space-between="0" data-speed="1000">

                                    <!-- Slides -->
                                    <div class="swiper-wrapper">
                                        <?php $__currentLoopData = $tl->getTablistProducts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tlPro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <article class="swiper-slide product-layout">
                                            <div class="product-thumb">
                                                <div class="product-inner">
                                                    <div class="product-image">
                                                        ...
                                                        <div class="label-product label-new">New</div>
                                                        <a href="single-product.html">
                                                            <img src="<?php echo e($tlPro->image); ?>" alt="<?php echo e($tlPro->name); ?>" title="<?php echo e(tlPro); ?>">
                                                        </a>
                                                        <div class="action-links">
                                                            <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                            <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                    ...
                                                    <div class="product-caption">
                                                        <div class="product-meta d-flex justify-content-between align-items-center">
                                                            <div class="product-manufacturer">
                                                                <a href="#"><?php echo e($tl->cate_name); ?></a>
                                                            </div>
                                                            <div class="product-ratings">
                                                                <div class="rating-box">
                                                                    <ul class="rating d-flex">
                                                        ...
                                                        <h4 class="product-name"><a href="single-product.html"><?php echo e($tlPro->name); ?></a></h4>
                                                        <p class="product-price">
                                                            <span class="price-new">$<?php echo e(number_format($tlPro->price, 0, '.', '.')); ?></span>
                                                        </p>
                                                    </div><!-- end of product-caption -->
                                                </div><!-- end of product-inner -->
                                            </div><!-- end of product-thumb -->
...
<?php echo $__env->make('layouts.client.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pt15312-web-php2\mvc\app\views/frontend/homepage.blade.php ENDPATH**/ ?>